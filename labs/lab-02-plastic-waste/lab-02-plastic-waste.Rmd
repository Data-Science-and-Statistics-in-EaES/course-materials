...
```{r add-your-chunk-label}
# add your code here, refer to the earlier code chunks for help
# remember, add facet_grid(___) or facet_wrap(___) after your geom_ line, using + and moving to a new line
```

```{marginfigure}
**NOTE:** From this point onwards the plots and the output of the code are not displayed in the lab instructions, but you should add and complete code chunks and view the results yourself.
```

🧶 ✅ ⬆️ *Now is a good time to knit your document and commit and push your changes to GitHub with an appropriate commit message (e.g., "Completed Exercise 1"). Make sure to commit and push all changed files so that your Git pane is cleared up afterwards.*

...
Then, for the exercises, create new code chunks, write the code yourself, and view the output.
...
1.  Convert your side-by-side box plots from the previous code chunk to [violin plots](http://ggplot2.tidyverse.org/reference/geom_violin.html). What do the violin plots reveal that box plots do not? What features are apparent in the box plots but not in the violin plots?
...
If you haven't had time to finish the exercises above by end of class on Wednesday, please ask for help on Slack, or go to Joey's office hours!
...
(Navigate to the GitHub repo folder that contains this Lab to check this.)

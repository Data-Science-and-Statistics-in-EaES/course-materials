...
You saw these once in class on Monday, they're outlined in detail here again.
...
Open the `lab-01-hello-r-starter` R Markdown (Rmd) file in your project directory, change the author name to your name, and knit the document.

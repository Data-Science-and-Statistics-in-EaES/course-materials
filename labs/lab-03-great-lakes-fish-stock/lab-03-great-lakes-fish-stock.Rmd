...
-   IL (Illinois); IN (Indiana); MI (Michigan); MN (Minnesota);
-   NY (New York); OH (Ohio); ON (Ontario); PA (Pennsylvania); WI (Wisconsin)
...
1.  How many observations and how many variables are in the dataset?
    ...
    Enter your answer in the `lab-03-great-lakes-fish-stock` starter file, under Exercise 1!
...
Remember you'll need to change eval = FALSE, to eval = TRUE, to run the chunk when you knit the starter file.

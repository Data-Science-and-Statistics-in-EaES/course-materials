...
**Sometimes exercises will be different, sometimes the same.**
...
- Setting up your group:
    ...
    2. Run `sample(1:n, 1)` (n = number in group). The number returned is the the group lead, and they hold the mineral! (The group lead will review and merge all Pull Requests!)
...
Remember: 
- everyone, writes their code (**USE UNIQUE CODE CHUNK LABELS**)
- knit, commit, push  (**Only push the starter .Rmd file!**)
...
2. Creates a scatter plot using ggplot, with `month_name` on the x axis, and the numerical data on the y axis. 

Discuss what is wrong with the plot?

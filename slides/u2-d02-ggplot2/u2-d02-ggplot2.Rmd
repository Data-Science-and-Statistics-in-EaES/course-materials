...
```{r ref.label = "penguins", echo = FALSE, warning = FALSE, out.width = "80%", fig.width = 8}
```
]
]
...
.pull-right[
```{r ref.label = "facet-color-legend", echo = FALSE, warning = FALSE, out.width = "90%"}
```
]
...
.pull-right[
```{r ref.label = "facet-color-no-legend", echo = FALSE, warning = FALSE, out.width = "90%"}
```
]

...
- If you are joining remotely, work on an `unit2-review-exercises-GROUP#`
...
## Exercise 1: Inpsect the first data frame
...
3. Add text narrative below the chunk stating the number of observations and rows.

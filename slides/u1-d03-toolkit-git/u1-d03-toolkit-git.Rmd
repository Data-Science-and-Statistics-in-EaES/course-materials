...
- **In Class**
  ...
  - Labs (may complete in class)
- **At home**
  - Homework (try for yourself)
  - Reading (statistics)
  - DataCamp (the basics of R coding)
  - Final Project (more later this semester)
]
]
.pull-right[
...
# Learning outcomes: 
 ...
 > Let's remind ourselves from the Syllabus!
...
- Adjust your GitHub settings for a more pleasant GitHub experience
  ...
  - **Create personal access token for pushing changes to Git**

<br>

*Next two classes...*

**GOAL: Work with R, RStudio, Git, and GitHub together for Lab 1 and Homework 1!**<sup>+</sup>

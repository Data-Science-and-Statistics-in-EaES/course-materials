...
### Pick a numerical variable and plot it against `orbial_class` () and make a visualisation (you pick the type!) to visualise the relationship between the two variables. Along with your code and output, provide an interpretation of the visualisation.
...
### Pick `orbital_class` and a second categorical variable and make a visualisation to visualise the relationship between the two variables. Along with your code and output, provide an interpretation of the visualisation.

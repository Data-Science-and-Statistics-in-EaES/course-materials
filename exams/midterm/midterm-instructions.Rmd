...
Please complete the blank section (`___`) with your name.
...
-   Edit this second code chunk so that the data is corrected during or after it is read in. (**Hint**: Examine the `name_repair` argument option in the read function help page for one method. Alternatively, pipe the read function output into a line that uses a function from the package `janitor`.)
